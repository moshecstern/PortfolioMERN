...
// export default function ProductCard() {
  ...
  const [{ data: ProductList, loading }, randomtext] = useAxios({
    headers: {
...
//   rating: 5,
//   display: true
//    title={Product.name+ " by "+ Product.manufacturer}
// subtitle={Product.form}  
// img={Product.img} 
// body1={"$"+Product.price+ " or "+ Product.deals}
// body2={"Only "+Product.salequantity+ " left"}
// body3={"MG / Dose: "+Product.mgperdose+ " By: "+ Product.dosesize+ ";  "+ Product.size+ " "+ Product.unitamount+" per "+ Product.container + " ; "+ "Total mg "+Product.mgpercontainer+ " in the form of: "+Product.form}
...
<Dbparagraph catagory={"editProduct"}/>
...
<Button onClick={openModalAdd}>Add a Product</Button>
</div>
}
      <Grid
  container
    ...
    {/* <div className={classes.root}> */}
      ...
      <TextField
        ...
        />
          ...
          variant="filled"
        />
           <Button onClick={addProduct}>Save Product member</Button>
